...
def generate_post():
    prompt = (
        ...
        "@❗️Важно:\n"
        "- Не выдумывай ссылки. Используй только реально существующие изображения.\n"
        "- Перед тем как добавить ссылку в `image_urls`, представь, что ты проверяешь её в браузере: она должна открываться.\n"
        "- Отдавай только прямые ссылки на файлы (.jpg/.png), а не на страницы.\n"
        "- Если не уверен — лучше не добавляй."\n"
