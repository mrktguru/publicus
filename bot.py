...
def generate_post():
    prompt = (
        ...
        "🔁 Вместо генерации ссылки — найди реальную существующую прямую ссылку на изображение картины.\n"
        "✅ Убедись, что изображение действительно открывается в браузере.\n"
        "❌ Не придумывай URL, не создавай фейковые или примерные ссылки.\n"
